...
**Current Context:** 0.5 (stresstest)
...
- Under which conditions does a statement hold?
...
## 2. Epistemic Contexts and Their Roles

The research program is organized into **epistemic contexts**.

An epistemic context defines the **conditions under which reasoning is permitted**.
Contexts are **not phases, levels, or maturity stages**.
They do not imply progress, improvement, or increased authority.

Multiple contexts may remain valid simultaneously.
...
### Context 0.5 — Stresstest (current)
...
## 3. What Context 0.4 Represents

Context **0.4** represents a **structurally complete epistemic architecture**.

It consolidates all prior contexts into a coherent framework that is:
...
Context 0.4 completes the **epistemic and architectural groundwork**
...
The repository supports exploration and constrained use
**without implicit authority**.
...
## 8. STOP — Scope, Limits, and Context Integrity
...
Any step beyond these limits requires a **context transition**, not an extension.
...
## 10. Context Philosophy

- Contexts define **conditions of admissibility**, not progress.
- Contexts may coexist.
- Earlier contexts remain valid in their own terms.
- Later contexts may fail without invalidating earlier ones.

Changing context means changing **rules**, not outcomes.

---

## 11. Final Note

If this repository feels careful, constrained, and sometimes frustrating,
that is intentional.
...
The research program exists to protect that question
